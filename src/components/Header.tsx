    ...
    >
      <nav className="container mx-auto px-6 flex items-center justify-between md:px-[24]">
        <a href="/" className="flex items-center gap-2 group" onClick={scrollToTop}>
          <span className="text-white text-lg font-medium tracking-wide">ArtSpace<span className="text-orange-300 ml-2 text-sm font-normal tracking-widest uppercase">дизайн студия</span></span>
        </a>
        ...
        <div className="hidden md:flex items-center gap-3">
          <a
            ...
            className="inline-flex items-center gap-2 text-sm px-5 py-2.5 bg-[#229ED9] text-white hover:bg-[#1a8bbf] transition-all duration-300"
          >
